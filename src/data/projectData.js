...
"hydroponic-farming": {
  ...
  "steel-metal": {
    ...
    introCards: [
      ...
      {
        text: "The Group has already signed contracts with overseas technology partners and the said technology will be imported very shortly once the Covid-19 impact subsides."
      },
      {
        text: "The source of funding will be self, which will be an added advantage in achieving the breakeven point earlier than the industry norms."
      },
      {
        text: "The Aaryan's Group has also done the required paperwork for selling the power to the industrial belt and state government departments and undertakings."
      },
      {
  ...
  "heavy-metal": {
    ...
    futureProspects: [
      {
        text: "Aaryans is investing a handsome amount of Rs. 2600 crores in this vertical and it is expected to generate an employment avenues for 1200 plus people of the country. The reason on venturing in this segment is due to the fact that the global needs on technology are depending on the precious metals like Titanium and Silicon worldwide. Also the gold mining business vertical of Aaryans will also be benefited & will be supplied dore (Gold) at the gold refinery of Aaryans at reasonable rates.",
        image: "/images/" // Image with hikers
      },
      {
        text: "Aaryans will also take care of the safety and other criteria fully and shall also impart on job training to the deserving candidate for the task. The mines so acquired in the foreign land will be also used to cater to the raw material needs in India in the manufacturing plants of the group, as stated here in above.",
        image: "/images/" // Image with beach wedding
      }
  ...
  // --- EDUCATION SECTOR ---
  "aviation-education-and-administration-university": {
  ...
  "education-sector-practical-knowledge-based": {
    ...
    futureProspects: [
      {
        text: "Presently School fees are touching the skies and are more of a burden than education. Our vision is to make education available at low cost. Our aim is to make education accessible to masses and should be available for all under right to education. We have desired and designed the education structure on the basis of Gurukul style of ancient teaching which does not only teach academics but also teaches human values to the pupils. This school shall be affiliated to the existing board of education of the city or state and we aim to make it a dream come true for every child. We will be investing around Rs. 200 crores and shall open employment for 250 people. We also look forward to make the text books and other study material available to all through our own printing segment and also at affordable and reasonable rates",
        image: "/images/" // Image with hikers
      }
    ]
  },
 ...
 "health-services-multi-speciality-hospital": {
  ...
  "cruise-shipping-and-program-business": {
    tag: "Services Sector",
  ...
  "sumukh-production-marathi-film-production-house": {
    tag: "Media & Entertainment",
    title: "SUMUKH",
    subtitle: "PRODUCTION",
  ...
  "news-uncut-marathi-news-channel": {
    ...
    socialLinks: [
      ...
      { platform: "google", url: "https://newsuncut.tv/" }
    
    ]
  },
  "ott-apps-idiot-box-and-saltpix": {
    tag: "Media & Entertainment",
    title: "IDIOT BOX &",
    subtitle: "SALTPIX",
  ...
  // --- PUBLICATIONS SECTOR ---
  "chitran-magazine-education-in-arts-and-drawing": {
